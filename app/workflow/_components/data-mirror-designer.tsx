            ...
            <TabsContent value="design" className="flex-1 h-full m-0 p-0">
              {isDesigningFlow ? (
                ...
                <div className="flex h-full">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        {selectedSource && (
                          <Card
                            ...
                            onClick={() => setIsDesigningFlow(true)}
                          >
                  ...
                  <Sheet
                    open={showSourceConfig}
                    onOpenChange={setShowSourceConfig}
                  >
                    <SheetContent
                      side="right"
                    ...
                    >
                      ...
                      <div className="space-y-4 mt-4">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Button
                            className="flex-1"
                            onClick={handleSourceConfigComplete}
                          >
                            确认
                          </Button>
                        </div>
